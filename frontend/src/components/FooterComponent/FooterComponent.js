            ...
            <footer className="text-center py-4">
                <div className="container">
                    <div className="row row-cols-1 row-cols-lg-3">
                        <div className="col">
                            <p className="text-muted my-2">Copyright&nbsp;© 2023 Kalboba</p>
                        </div>
                        <div className="col">
                        ...
                        <div className="col">
                            <ul className="list-inline my-2">
                                <li className="list-inline-item"><a className="link-secondary text-muted" href="#">Privacy Policy</a></li>
                                <li className="list-inline-item"><a className="link-secondary text-muted" href="#">Terms of Use</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
